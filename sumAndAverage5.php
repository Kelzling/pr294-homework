...
function printSumAndAverage()
{
    ...
    global $count;
    echo "Max value entered was $maxValue <br/> the sum of all odd numbers up to and including $maxValue is $sum, the count of numbers was $count and the average is $average";
}
...
<body>
<form action="sumAndAverage5.php" method="POST">
<p>Press 'calculate' to see the sum of all odd numbers up to your entered number, and the average.</p>
